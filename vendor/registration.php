...
//     class Registartion extends Secure{
//         private static $name = htmlspecialchars($_POST['username']);
//         private static $surname = htmlspecialchars($_POST['surname']);
//         private static $email = htmlspecialchars($_POST['email']);
//         private static $pass = htmlspecialchars($_POST['pass']);

//         private static $date = htmlspecialchars($_POST['Y-m-d H:i:s']);
//         private static $ip = htmlspecialchars($_POST['REMOTE_ADDR']);


//         protected function checkSec(){
//             $error = '';
//             if (!empty($user)) {
